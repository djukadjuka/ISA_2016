...
insert into product(id, description, name, price)
values (100002, 'Quattro Formaggi, Italy', 'Pizza with four different types of cheese.', 7);

insert into product(id, description, name, price)
values (100003, 'Beef Wellington, Italy', 'Famous bread crusted beef dish.', 15);

insert into product(id, description, name, price)
values (100004, 'Seafood paella, Spain', 'Shrimp, lobster, mussels and cuttlefish combine with white rice and various herbs.', 14);

insert into product(id, description, name, price)
values (100005, 'Som tam, Thailand', ' Thailands most famous salad, pound garlic and chilies with a mortar and pestle. ',14 );

insert into product(id, description, name, price)
values (100006, 'Chicken rice, Singapore', 'Boiled chicken is served atop fragrant oily rice, with sliced cucumber.', 10);
...
insert into product(id, description, name, price)
values (100010, 'French toast, Hong Kong', 'Hong Kong-style French toast.', 11);

insert into product(id, description, name, price)
values (100011, 'Chicken parm, Australia', 'Melted Parmesan and mozzarella cheese, and a peppery, garlicky tomato sauce.', 6);

insert into product(id, description, name, price)
values (100012, 'Chili crab, Singapore', 'Spicy, sloppy, meaty specialty.', 11);

insert into product(id, description, name, price)
values (100013, 'Fish ‘n’ chips, Britain', 'Sprinkled with salt, vinegar and dollops of tartar sauce.', 10);

insert into product(id, description, name, price)
values (100014, 'Ankimo, Japan', 'The monkfish/anglerfish that unknowingly bestows its liver upon upscale sushi fans.', 11);

insert into product(id, description, name, price)
values (100015, 'Montreal-style smoked meat, Canada', 'smoked beef sandwich medium-lean, heavy on the mustard.', 12);

insert into product(id, description, name, price)
values (100016, ' Fajitas, Mexico', 'Meat, throw side servings of capsicum, onion, guacamole, sour cream.', 13);

insert into product(id, description, name, price)
values (100017, 'Champ, Ireland', ' Mashed potato with spring onions.', 4);

insert into product(id, description, name, price)
values (100018, ' Lasagna, Italy', ' pasta-layered, tomato-sauce-infused, minced-meat.', 10);

insert into product(id, description, name, price)
values (100019, 'Croissant, France', 'Flaky pastry smothered in butter.', 2);

insert into product(id, description, name, price)
values (100020, 'Arepas, Venezuela', 'A corn-dough patty that provides a savory canvas .', 4);

insert into product(id, description, name, price)
values (100021, 'Kebab, Iran', 'REMOVE!', 1);

insert into product(id, description, name, price)
values (100022, 'Kalua pig, United States', 'Whole pig roasted in an underground sand pit for six or seven hours.', 25);

insert into product(id, description, name, price)
values (100023, 'Donuts, United States', 'Well known US snack.', 2);

insert into product(id, description, name, price)
values (100024, 'Shepherd’s pie, Britain', 'Minced lamb topped with mashed potato', 13);

insert into product(id, description, name, price)
values (100025, 'Chicken muamba, Gabon', 'Chicken, hot chili, garlic, tomato, pepper, salt, okra and palm butter', 10);

insert into product(id, description, name, price)
values (500001, 'Geil Trocken Spätburgunder', 'Famous Wine 2015', 22);

insert into product(id, description, name, price)
values (500002, 'Domaine Jorel, La Garrigue', 'Rare Wine 2003', 32);

insert into product(id, description, name, price)
values (500003, 'Stoller Reserve Chardonnay', 'Famous Chardonnay 2014', 33);

insert into product(id, description, name, price)
values (500004, 'Omero Cellars Pinot Gris', 'Well known Pinot, 2014', 22);

insert into product(id, description, name, price)
values (500005, 'Ghost Pines Zinfandel', 'Excellent German Wine 2014', 16);

insert into product(id, description, name, price)
values (500006, 'Guinness', 'Irelands famous beer.', 10);

insert into product(id, description, name, price)
values (500007, 'Bud Light', 'US famous beer.', 4);

insert into product(id, description, name, price)
values (500008, 'Budweiser', 'US most popular beer.', 5);

insert into product(id, description, name, price)
values (500009, 'Skol', 'Famous Brazillian beer.', 2);

insert into product(id, description, name, price)
values (500010, 'Heineken', 'Best beer from the Netherlands', 10);

insert into product(id, description, name, price)
values (500011, 'Coca-Cola', 'US famous soft drink.', 2);

insert into product(id, description, name, price)
values (500012, 'Pepsi', 'US second famous soft drink.', 2);

insert into product(id, description, name, price)
values (500013, 'Sprite', 'Refreshing soft drink.', 2);

insert into product(id, description, name, price)
values (500014, 'Lemonade', 'Ice cold drink made from fresh lemons.', 3);

insert into product(id, description, name, price)
values (500015, 'Orangina', 'Best soft drink from wherever the hell it is.', 999);
